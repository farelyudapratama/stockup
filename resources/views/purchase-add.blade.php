    ...
    <div class="min-h-screen bg-gray-100 flex items-center justify-center z-10">
        <div class="max-w-screen-lg w-full space-y-8 bg-white rounded-xl shadow-2xl overflow-hidden">
            <div class="bg-blue-600 px-6 py-4">
                <h2 class="text-2xl font-bold text-white text-center">Tambah Pembelian Baru</h2>
            </div>

            <form action="{{ route('purchases.store') }}" method="POST" class="px-6 py-8 space-y-6">
                @csrf
                ...
                <div>
                    ...
                    @else
                        <select id="vendor_id" name="vendor_id" disabled
                            class="w-full px-3 py-2 border border-gray-300 rounded-md shadow-sm focus:outline-none focus:ring-2 focus:ring-red-500 focus:border-red-500 transition duration-150 ease-in-out">
                            <option value="">Tidak ada vendor tersedia</option>
                        </select>
                    @endif
                </div>
                ...
                <div id="products-container">
                    @if (count($products) > 0)
                        <div class="product-item grid grid-cols-1 sm:grid-cols-3 gap-4 mb-4">
                            ...
                            <div>
                                ...
                                <input type="number" name="products[0][unit_price]" required min="0"
                                    step="0.01"
                                    class="w-full px-3 py-2 border border-gray-300 rounded-md shadow-sm focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-blue-500 transition duration-150 ease-in-out"
                    ...
                    @else
                        <p class="text-red-500">Tidak ada produk tersedia. Tambahkan produk terlebih dahulu.</p>
                    @endif
                </div>
