        ...
        <div class="bg-white shadow-md rounded-lg overflow-hidden">
            <div class="flex flex-col gap-4 bg-gray-100 p-4 border-b">
                ...
                <div class="flex flex-col sm:flex-row items-start sm:items-center gap-4">
                    <form method="GET" action="{{ route('prices.index') }}" class="flex-1 min-w-[280px]">
                                ...
                                <td class="py-3 px-4">
                                    <div class="flex gap-4 justify-center">
                                        ...
                                        <form action="{{ route('prices.destroy', $product->id) }}" method="POST"
                                            class="inline"
                                            onsubmit="return confirm('Apakah Anda yakin ingin menghapus semua harga untuk produk ini?')">
                                            @csrf
                                            @method('DELETE')
